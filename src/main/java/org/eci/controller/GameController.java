// src/main/java/org/eci/controller/GameController.java
...
public class GameController {
    ...
    public void joinLobby(Map<String, String> data) {
        ...
        if (!validateInput(gameName) || !validateInput(userName)) {
    ...
    public void selectTopic(Map<String, String> data) {
        ...
        if (!validateInput(gameName) || !validateInput(selectedTopic)) {
            return; // Invalid input, do not proceed
        }
    ...
    public void submitAnswer(Map<String, String> data) {
        ...
        if (!validateInput(gameName) || !validateInput(userName) || !validateInput(selectedOption)) {
            return; // Invalid input, do not proceed
        }
